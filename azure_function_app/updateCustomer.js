module.exports = async function (context, req) {
    context.log('START updateCustomer');
    ...
    if (!customer) {
        context.res = {
            status: 400,
            body: `Customer with email ${req.query.email} not found.`
        };
        context.done();
    }
    ...
    context.res = {        
        body: `Customer with email ${req.query.email} successfully updated.`
    };    
      
    context.log('END updateCustomer');
};
